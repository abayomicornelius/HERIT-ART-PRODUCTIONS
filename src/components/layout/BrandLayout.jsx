...
const LINKS = [
  { to: '/brand/dashboard',  label: 'Dashboard',    icon: 'dashboard' },
  { to: '/brand/projects',   label: 'Projects',     icon: 'projects'  },
  { to: '/brand/team',       label: 'Team',         icon: 'team'      },
  { to: '/brand/subscription', label: 'Subscription', icon: 'sub'     },
]

export default function BrandLayout({ children, title, subtitle, actions }) {
  return (
